...
L["Reset the current profile back to it's default values, in case your configuration is broken, or you simply want to start over."] = "Ripristina/Resetta l'attuale profilo ai suoi valori di base, nel caso la configurazione attuale risulti sballata, oppure, piu' semplicemente, perche' si desidera rifarla da capo"
...
L["You can either create a new profile by entering a name in the editbox, or choose one of the already existing profiles."] = "Puoi creare un nuovo profilo inserendo il nome nel box di edit, oppure puoi sceglierne uno di quelli gia' presenti"
...
L["\nCarbonite is a full featured, powerful map addon providing a versitile easy to use google style map which either can replace or work with the current blizzard maps.\n\nThrough modules it can also be expanded to do even more to help make your game easier."] = "\nCarbonite e' un potente e completo addon che mette a disposizione un semplice e versatile strumento in stile GOOGLE-MAPS, il quale puo' rimpiazzare e/o lavorare in collaborazione con la mappa di base di Blizzard. \n\nCon diversi moduli a disposizione e' possibile espandere Carbonite ed ottenere uno strumento estremamente potente che ti permette di rendere un po' piu' semplice la tua esperienza di gioco"
...
L["JimboBlue for guide location updates and checking"] = "JimboBlue, per le locazioni delle guide e loro mantenimento"
...
L["JimboBlue for guide location updates"] = "JimboBlue, per gli aggiornamenti alle locazioni delle guide"
...
L["Use Carbonite Map instead of Blizzards (Alt-M will open world map)"] = "Utilizza la Mappa di Carbonite invece di quella Blizzard (Alt+M aprira' la mappa del Mondo)"
L["When enabled, pressing 'M' will maximize the carbonite map instead of opening the world map."] = "Quando abilitato, premendo il tasto 'M' aprira' la Mappa di Carbonite invece di quella di default della Blizzard"
L["Enable Compatability Mode"] = "Abilita Modalita' di Compatibilita'"
L["When Enabled, Carbonite will performe combat checks before any map/window functions. This eliminates other UI's from causing protected mode errors."] = "Quando abilitato, Carbonite fara' dei controlli di conflitto prima di ogni funzione di mappa o di finestra. Questo impedisce ad altre Interfacce Grafiche di generare Errori di Protezione"
L["Center map when maximizing"] = "Centra Mappa Massimizzata"
L["When enabled, the map will center on your current zone when you maximize it"] = "Quando abilitato, la mappa, quando massimizzata, sara' centrata sulla tua attuale zona"
L["Ignore mouse on map except when ALT is pressed"] = "Ignora Puntatore Mouse sulla Mappa"
L["When enabled, the small game map will ignore all mouse clicks unless the ALT key is held down."] = "Quando abilitato, la piccola mappa di gioco ignorera' tutti i click del mouse, a meno che non venga premuto il tasto ALT"
L["Ignore mouse on full-sized map except when ALT is pressed"] = "Ignora Puntatore Mouse sulla Mappa Grande"
L["When enabled, the full size map will ignore all mouse clicks unless the ALT key is held down."] = "Quando abilitato, la mappa grande ignorera' tutti i click del mouse, a meno che non venga premuto il tasto ALT"
...
L["When enabled, pressing either 'M' or ESC will close the maximized map instead of switching back to small map."] = "Quando abilitato, premendo 'M' o ESC chiudera' la mappa invece di passare a quella piccola"
L["Show Friends/Guildmates in Cities"] = "Mostra Amici/Gildani nelle Citta'"
...
L["Show Other people in Cities"] = "Mostra altre persone nelle Citta'"
...
L["When enabled, will attempt to draw a marker on the map for other Carbonite users."] = "Quando abilitato, chiunque della tua Fazione abbia Carbonite installato ed abilitato, verra' visualizzata la sua posizione sulla mappa"
L["Restore map scale after track"] = "Ripristina Dimensione Mappa dopo Tracciatura"
L["When enabled, restores your previous map scale when tracking is cleared."] = "Quando abilitato, terminata la tracciatura verra' ripristinata la dimensione di base della mappa"
...
L["Show Speed"] = "Mostra Velocita'"
L["When enabled, Shows your current movement speed in the titlebar."] = "Quando abilitato, mostra la velocita' di movimento nella barra del titolo della mappa"
...
L["When enabled, Carbonite will combine the minimap into itself to create a more functional minimap for you (RELOAD REQUIRED)"] = "Quando abilitato, fondera' la Minimappa di Carbonite con la Minimappa Standard della Blizzard (RICHIEDE /reload)"
L["Minimap Shape is Square"] = "Minimappa Quadrata"
L["When enabled, Carbonite will change the minimap shape from circle to square"] = "Quando abilitato, Carbonite cambiera' l'aspetto della mappa standard 'circolare' in una mappa 'quadrata'"
L["Minimap is drawn above icons"] = "Minimappa Sopra, Icone Sotto"
L["When enabled, Carbonite will draw the minimap above your map icons, you can use the CTRL key on your keyboard to toggle which layer is top"] = "Quando abilitato, Carbonite mostrera' la Minimappa sopra la mappa delle Icone. il tasto CTRL della tastiera cambia l'odine di strato"
...
L["Sets the scale of the icons drawn in the minimap portion of the map while docked"] = "Imposta la dimensione delle Icone della Minimappa quando quest'ultima e' ancorata"
L["Minimap Node Glow Delay"] = "Velocita' Pulsazione Nodi di Raccolta"
L["Sets the delay (in seconds) between the glow change on gathering nodes (0 is off)"] = "Imposta (in secondi) la velocita' di pulsazioni dei Nodi di Raccolta (Erbalismo ed Estrazione) sulla minimappa - '0' (zero) disabilita la funzione"
L["Always dock minimap"] = "Ancora SEMPRE Minimappa"
L["When enabled, The minimap will always dock into the corner of the carbonite map."] = "Quando abilitato, la minimappa sara' SEMPRE ancorata nel angolo della mappa di Carbonite"
L["Dock The Minimap when indoors"] = "Ancora Minimappa negli Interni"
L["When enabled, The minimap will dock if wow says your indoors"] = "Quando abilitato, la minimappa verra' ancorata se si entrera' nell'interno di una struttura e/o se il Client definisce l'attuale ambiente come 'Interno' di qualcosa"
L["Dock The Minimap in Bugged Zones"] = "Ancora Minimappa in Zone Bugghe"
L["When enabled, The minimap will dock if your in a known transparency bug zone (Pitch black minimap)"] = "Quando abilitato, la minimappa verra' ancorata se si entrera' in una zona e' conosciuta per il bug alla trasparenza (minimappa 'nero come la pece')"
L["Dock The Minimap when Fullsized"] = "Ancora Minimappa - Mappa Max Dimansione"
L["When enabled, The minimap will dock if your viewing the fullsized map."] = "Quando abilitato, la minimappa sara' ancorata se si sta consultando la Mappa con dimensione massimizzata (Full size)"
L["Hide The Minimap when Fullsized"] = "Nascondi Minimappa - Mappa Max Dimensione"
L["When enabled, The minimap will hide if your viewing the fullsized map."] = "Quando abilitato, la minimappa risultera' nascosta se si sta consultando la Mappa con dimensione massimizzata (Full Size)"
L["Minimap Docked Shape is Square"] = "Minimappa Ancorata -> Quadrata"
L["When enabled, The minimap will be square shaped while docked."] = "Quando abilitato, se la minimappa sara' ancorata la sua forma risultera' QUADRATA"
L["Minimap Docks Bottom"] = "Ancoraggio Minimappa - Basso"
L["When enabled, The minimap will dock to the bottom of the map."] = "Quando abilitato, la minimappa sara' ancorata ai piedi della Mappa"
L["Minimap Docks Right"] = "Ancoraggio Minimappa - Destra"
L["When enabled, The minimap will dock to the right side of the map."] = "Quando abilitato, la minimappa sara' ancorata sul lato destro della Mappa"
...
L["When enabled, The minimap will expand to full map window size when indoors."] = "Quando abilitato, la minimappa verra' espansa a Mappa in Massima dimensione quando si e' in un Interno"
L["Minimap goes full sized in bugged areas"] = "Max Dimensione Minimappa Zone Bugghe"
L["When enabled, The minimap will expand to full map window size in known transparency bugged areas."] = "Quando abilitato, la minimappa verra' espansa a Mappa in Massima Dimensione quando si giunge in una zone in cui vi e' un un BUg conosciuto sulla trasparenza"
L["Minimap goes full sized in instances"] = "Max Dimansione Minimappa Istanze"
L["When enabled, The minimap expand to full map window size when you enter a raid/instance."] = "Quando abilitato, la minimappa verra' espansa a Mappa in Massima Dimensione quando si entra in una istanza/Raid"
...
L["When enabled, will record all the resource nodes you gather"] = "Quando abilitata, memorizzera' tutti i punti di raccolta (erbe e minerali) che avrai usato"
...
L["When Enabled, Carbonite Menus Will Be Drawn Horizontally Centered On The Mouse"] = "Quando abilitato, il Menu di Carbonite verra' mostrato centrato orizzontalmente sul Puntatore del Mouse"
L["Center Menus Vertically On Cursor"] = "Centra Menu Vert."
L["When Enabled, Carbonite Menus Will Be Drawn Vertically Centered On The Mouse"] = "Quando abilitato, il Menu di Carbonite verra' mostrato centrato verticalmente sul Puntatore del Mouse"

-- Privacy Options
L["Privacy Options"] = "Opzioni Privacy"
L["Send Position & Level Ups To Friends"] = "Posizione + Livellamento agli Amici"
L["When Enabled, Carbonite will send your current location and any levelups you get to your other friends using carbonite"] = "Quando abilitato, Carbonite inviera' informazioni sulla tua posizione ed i tuoi passaggi di livello, a coloro presenti nella tua lista amici che utilizzano Carbonite loro stessi"
L["Send Position & Level Ups To Guild"] = "Posizione + Livellamento alla Gilda"
L["When Enabled, Carbonite will send your current location and any levelups you get to your other guildmates using carbonite"] = "Quando abilitato, Carbonite inviera' informazioni sulla tua posizione ed i tuoi passaggi di livello, ai Membri della tua Gilda che utilizzano Carbonite loro stessi"
L["Send Position & Level Ups To Zone"] = "Posizione + Livellamento a chiunque"
L["When Enabled, Carbonite will send your current location and any levelups you get to other carbonite useres in your current zone"] = "Quando abilitato, Carbonite inviera' informazioni sulla tua posizione ed i tuoi passaggi di livello, a tutti coloro che utilizzano Carbonite loro stessi"
L["Show Received Levelups"] = "Mostra Livellamenti Ricevuti"
L["When Enabled, Carbonite will show a message in chat whenever it gets a notice someone leveled up"] = "Quando abilitato, Carbonite mostrera' un messaggio in chat quando ricevera' un avviso che qualcuno e' passato di Livello"
...
L["When Enabled, Carbonite will listen on a global channel for versions others are using so it can tell you if an update is available"] = "Quando abilitato, Carbonite restera' in ascolto sul Canale Globale per ricevere notifiche di aggiornamenti di Carbonite stesso"
L["Enable Zone Channel (Used for locations of others in your zone)"] = "Abilita Canale Zona"
L["When Enabled, Carbonite will send your current location and listen for messages from others who are in the same zone as you"] = "Quando abilitato, Carbonite inviera' la tua posizione e restera' in ascolto di eventuali messaggi da altri utenti"
