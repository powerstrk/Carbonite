...
L["When enabled, Carbonite will use the enhanced social window instead of blizzards (REQUIRES RELOAD)"] = "Quando abilitata, Carbonite userà la finestra Collaboratori Avanzata invece di quella Blizzard (RICHIEDE /reload)"
...
L["When enabled, Carbonite will hide the punk window"] = "Quando abilitata, Carbonite nasconderà la finestra Avversari"
L["Lock the Punk Window"] = "Blocca Finestra Avversari"
L["When enabled, Carbonite will lock the punk window"] = "Quando abilitata, Carbonite bloccherà la posizione della finestra Avversari"
...
L["When enabled, Carbonite will show a message on other users in the zone detecting punks"] = "Quando abilitata, Carbonite mostrerà un messaggio agli altri utenti che utilizzano Carbonite, della tua fazione, quando viene individuato un Avversario"
L["Play Others Punk Sound"] = "Usa Suono di Allerta su Avversari da Altri Giocatori"
L["When enabled, Carbonite will play a sound when another Carbonite user in the zone sees a punk"] = "Quando abilitata, Carbonite emetterà un segnale acustico quando un altro giocatore, che sta usando Carbonite, rileverà un Avversario"
L["Show Punks Message"] = "Mostra Messaggio Avversari"
L["When enabled, Carbonite will show a message in your chat when you detect a punk"] = "Quando abilitata, Carbonite visualizzerà un messaggio nella tua chat quando un Avversario viene individuato"
L["Play Punk Sound"] = "Allerta Acustica Avversari"
L["When enabled, Carbonite will play a sound when you detect a new punk"] = "Quando abilitata, Carbonite emetterà un segnale acustico quando il tuo sistema individua un Avversario"
L["Show Punks In Safe Areas"] = "Mostra Avversari in Zone Sicure"
L["When enabled, Carbonite will show punks even in sanctuary areas"] = "Quando abilitata, Carbonite mostrerà gli Avversari anche nelle Zone Rifugio (Dalaran, Shattrath etc. etc. etc.)"
L["Show Punks On Map"] = "Mostra Avversari sulla Mappa"
L["When enabled, Carbonite will show punks on your map"] = "Quando abilitata, Carbonite mostrerà gli Avversari sulla tua mappa"
...
L["When enabled, Carbonite will show punks on your map in battlegrounds"] = "Quando abilitata, Carbonite mostrerà gli Avversari sulla tua mappa nei Campi di Battaglia"
