...
L["If you have HandyNotes installed, allows them on the Carbonite map"] = "Si vous avez Handynotes install\195\169, autorise celui-ci sur la map Carbonite"
L["Handnotes Icon Size"] = "Taille d' ic\195\180ne Handynotes"
