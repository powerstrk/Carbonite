...
L["Color of Watched Areas on Mouse Over"] = L["Color of Watched Areas on Mouse Over"] = "Couleur des zones suivies au passage du curseur de la souris"
...
L["Search: [click]"] = "Rechercher: [clic]" -- true in patch10 needs review
