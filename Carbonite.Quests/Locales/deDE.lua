...
L["When enabled, leaves L as the default blizzard window and Alt-L for carbonite quests"] = "Das Blizzard-Questfenster wird mit L und das Carbonite-Questfenster mit ALT-L ge\195\182ffnet."
L["Show Quests Side by Side"] = "Quests nebeneinander anzeigen"
L["When enabled, shows the quest details to the right side of the quest window"] = "Die Questdetails werden auf der rechten Seite des Questfensters angezeigt."
L["Show Daily Reset Time"] = "Tagesquest R\195\188cksetzzeit anzeigen"
L["When enabled, shows the time until dailies reset"] = "Die Zeit, bis die Tagesquests zur\195\188ckgesetzt werden."
...
L["When enabled, shows the quest ID beside the quest"] = "Die ID der Quests wird neben der Quest angezeigt."
L["Quest Details Background Color"] = "Questbeschreibunghintergrundfarbe"
L["Quest Details Text Color"] = "Questbeschreibungstextfarbe"
L["Quest Details Scale"] = "Skalierung der Beschreibung"
...
L["When enabled, adds quest information to tooltips"] = "Questinfos werden zu den Kurzinfos hinzugef\195\188gt"
L["Share Quest Progress"] = "Questfortschritt teilen"
L["When enabled, shares your quest progress to group members and accepts their shares"] = "Der Questfortschritt wird mit den Gruppenmitgliedern geteilt und deren Teilungen akzeptiert"
L["Auto Accept Quests"] = "Quests automatisch annehmen"
L["When enabled, will auto accept quests that get offered to you"] = "Quests werden automatisch angenommen, die dem Spieler angeboten werden"
L["Auto Turn In Quests"] = "Quests automatisch abgeben"
L["When enabled, automatically turns in quests"] = "Quests werden automatisch abgegeben, sobald man den Questgeber erreicht"
L["Auto Turn In Self-Completion Quests"] = "Selbst-komplettierende Quests automatisch abgeben"
L["When enabled, auto turns in quests that are self-completing"] = "Quests, die der Spieler selbst beenden kann, werden automatisch abgegeben."
L["Broadcast Quest Changes"] = "Quest\195\164nderungen \195\182ffentlich"
L["When enabled, will send a group/raid message when you complete an objective"] = "Bei Beendigung eines Questziels wird eine Nachricht an Gruppen/Raid-Mitglieder gesendet"
L["Broadcast after number of changes"] = "Anzahl von \195\132nderungen f\195\188r Nachricht"
...
L["When enabled, adds information about level and part number in quest links"] = "Informationen \195\188ber Level und Anzahl werden im Questlink angezeigt" -- weiss wer was besseres als "Teil-Nummer" wie wäre "Anzahl"?
L["Get Completed Quest Information on Login"] = "Informationen \195\188ber abgeschlossene Quests beim Login holen"
L["When enabled, will get all your completed quests from the server each login"] = "Die Informationen dar\195\188ber, welche Quests bereits abgeschlossen sind, werden beim Login vom Server geholt"
...
L["When enabled, will always show your watched quests on the map. This only works for quests carbonite knows"] = "Beobachtete Quests werden immer auf der Karte angezeigt. Diese Funktion steht nur f\195\188r Quests zur Verf\195\188gung, die Carbonite bekannt sind"
...
L["Sets the graphic to be used for watched areas"] = "Welche Grafik bei beobachteten Gebieten angezeigt werden soll festlegen"
L["Use One Color Per Quest"] = "Nutze eine Farbe pro Quest"
L["When enabled, will use one specific color per quest area"] = "Pro Questgebiet wird eine einzelne Farbe verwendet"
...
L["When enabled, stops carbonite from displaying the quest watch window"] = "Das Fenster zur Questverfolgung wird von Carbonite nicht mehr angezeigt"
L["Hide Quest Watch Window in Raids"] = "Questverfolgungsfenster in Raids verstecken"
L["When enabled, stops carbonite from displaying the quest watch window while your in a raid"] = "Das Fenster zur Questverfolgung wird von Carbonite w\195\164hrend eines Raids nicht mehr angezeigt"
L["Lock Quest Watch Window"] = "Questverfolgungsfenster feststellen"
L["When enabled, stops carbonite from being able to move"] = "Das Fenster zur Questverfolgung wird an seiner aktuellen Position fixiert, so dass man es nicht mehr bewegen kann"
L["Grow quest watch window Upwards"] = "Questverfolgungsfenster nach oben erweitern"
L["When enabled, objectives and quests get added in an upward direction instead of down"] = "Das Questverfolgungsfenster wird beim Hinzuf\195\188gen neuer Quests nach oben und nicht nach unten vergr\195\182\195\159ert"
L["Use A Fixed Size for Quest Watch"] = "Feste Questverfolgungs-Fenstergr\195\182\195\159e"
L["When enabled, the carbonite quest watch window does not allow resizing, just movement (RELOAD REQUIRED)"] = "Das Carbonite-Fenster wird zur Questverfolgung nicht mehr skalier-, sondern nur noch verschiebbar (Neuladen erforderlich)"
L["Hide Blizzards Quest Track Window"] = "Blizzard-Questverfolgungsfenster verstecken"
L["When enabled, hides blizzards version of the track window"] = "Das Blizzard-Fenster wird zur Questverfolgung versteckt"
L["Disable Blizzards Auto Quest Tracking"] = "Deaktiviere Blizzards automatische Questverfolgung"
L["When enabled, turns off blizzards quest watch window auto adding new quests (RELOAD REQUIRED)"] = "Das automatische Hinzuf\195\188gen von Quests in Blizzards Questfenster wird ausgeschaltet (Erfordert Neuladen)"
...
L["When enabled, syncs the two watch lists which enables blizzard quest blobs to appear on the minimap"] = "Carbonite-Questfenster und Blizzard-Questfenster werden synchronisiert, so dass Blizzard-Questblobs auf der Minimap auftauchen"
...
L["When enabled, any new quest you pickup is automatically watched"] = "Jede neu angenommene Quest wird automatisch verfolgt"
L["Auto Watch Changed Quests"] = "Automatisch ge\195\164nderte Quests verfolgen"
L["When enabled, any quest whose objective changes from you looting an item, or talking to someone is automatically watched"] = "Quests deren Ziele sich ge\195\164ndert haben, weil ein Objekt aufgenommen oder mit jemandem gesprochen wurde, wird automatisch verfolgt"
...
L["When enabled, attempts to display how far approximately you are from a quest or objective"] = "Versucht die ungef\195\164hre Entfernung vom n\195\164chsten Questziel anzuzeigen"
L["Auto Hide Finished Objectives"] = "Abgeschlossene Ziele automatisch verstecken"
L["When enabled, objectives that are 100% complete will be removed from the list"] = "Questziele, die zu 100% erreicht wurden, werden von der Questliste entfernt"
L["Show Objective Amount First"] = "Questziel-Menge voranstellen"
L["When enabled, puts your objective progress before the objective instead of after"] = "Die erreichte Menge an Questzielen bzw. der Fortschritt wird vor der Questbeschreibung dargestellt, statt dahinter"
L["Watch Scenarios"] = "Szenarios verfolgen"
L["When enabled, will place scenario status at the top of your watch window"] = "Die Statusinformationen von Szenarios werden im Questfenster ganz oben angezeigt"
L["Watch Achievements"] = "Erfolge verfolgen"
L["When enabled, will place any tracked achievements at the top of your watch window"] = "Erfolge, die im Questfenster verfolgt werden, werden ganz oben angezeigt"
L["Watch Bonus Tasks"] = "Bonus-Aufgaben verfolgen"
L["When enabled, will place bonus tasks onto the quest tracker when your in range."] = "Bonus Aufgaben werden im Questfenster angezeigt, sobald sie in Reichweite kommen."
L["Show Progress Bar instead of Text"] = "Zeige Leiste anstelle von Text"
L["If active, instead of a text, the percentage of progress will be shown with a bar."] = "Vor der Prozentzahl wird eine Prozent-Leiste anstelle eines Textes angezeigt"
L["Watch Challenge Modes"] = "Verfolge Herausforderungsmodus"
L["When enabled, will place the timer for your challenge mode at the top of your watch window"] = "Die Zeitanzeige f\195\188r den Herausforderungsmodus wird oben im Questfenster angezeigt"
L["Show Zone Achievement if Known"] = "Zeige bekannte Zonen-Erfolge"
L["When enabled, if carbonite knows there is a zone achievement for number of quests it will display it"] = "Carbonite wird jene Zonen-Erfolge, die bekannt sind, anzeigen"
L["Show Close Button"] = "Zeige Schlie\195\159en-Knopf"
L["When enabled, will place a button on the watch window to close it (RELOADS UI)"] = "Carbonite wird einen Schlie\195\159en-Knopf im Questfenster anzeigen (Neuladen erforderlich)"
L["Fade Entire Window"] = "Gesamtes Fenster ausblenden"
L["When enabled, if the quest watch window fades, will ensure all of it fades text and all instead of just the window itself"] = "Sichergestellt wird, dass nicht nur das Questfenster ausgeblendet wird, sondern auch Texte und sonstiger Inhalt"
...
L["When enabled, will color your objectives based on how complete they are"] = "Die Quests werden entsprechend ihres Fortschritts eingef\195\164rbt"
...
L["When enabled, one of the selected sounds below will play on quest completion"] = "Die ausgew\195\164hlte Meldung bei Abschlu\195\159 einer Quest wird abgespielt"
