...
L["When enabled, will place bonus tasks onto the quest tracker when your in range."] = "Wenn eingestellt, werden Bonus Aufgaben im Questfenster angezeigt, sobald sie in Reichweite kommen."
L["Show Progress Bar instead of Text"] = "Zeige Leiste anstelle von Text"
L["If active, instead of a text, the percentage of progress will be shown with a bar."] = "Wenn eingestellt, werden vor der Prozentzahl eine Prozent-Leiste anstelle eines Textes angezeigt"
...
L["Load Quests for Levels 91-100"] = "Lade Quests f\195\164r Stufe 91-100"
