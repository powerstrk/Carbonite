...
L["When enabled, will send a group/raid message when you complete an objective"] = "Quando Abilitato, verra' inviato al gruppo/raid un messaggio quando tu completi una missione"
...
L["When enabled, stops carbonite from displaying the quest watch window while your in a raid"] = "Quando Abilitato, Carbonite non visualizza la Finestra Mostra Missioni fino a che si e' in Raid"
...
L["When enabled, the carbonite quest watch window does not allow resizing, just movement (RELOAD REQUIRED)"] = "Quando Abilitato, la Finestra Mostra Missioni di Carbonite non permettera' ridimensionamenti, solo spostamenti (RICHIESTO /reload)"
L["Hide Blizzards Quest Track Window"] = "Nascondi Finestra Mostra Missioni Blizzard"
L["When enabled, hides blizzards version of the track window"] = "Quando Abilitato, verra' nascosta la Finestra Mostra Missioni di Blizzard"
...
L["Sets the number of characters before an objective wraps"] = "Imposta la quantita' di caratteri tipografici prima dell'acapo"
...
L["When enabled, any new quest you pickup is automatically watched"] = "Quando abilitata, ogni nuova missione ricevuta sara' visualizzata nella lista in automatico"
L["Auto Watch Changed Quests"] = "Visualizza Progressione Missione Automatico"
L["When enabled, any quest whose objective changes from you looting an item, or talking to someone is automatically watched"] = "Quando abilitata, visualizza gli oggetti recuperati e/o i punti raggiunti e/o se si e' parlato con un determinato soggetto"
...
L["When enabled, will place scenario status at the top of your watch window"] = "Quando abilitata, lo status dello scenario/missione bonus verra' visualizzato alla cima della lista delle missioni"
L["Watch Achievements"] = "Visualizza Traguardi"
L["When enabled, will place any tracked achievements at the top of your watch window"] = "Quando abilitata, tutti i Traguardi (Achievements) di cui e' stato scelto di tener traccia, verranno visualizzati in cima alla lista delle missioni"
L["Watch Bonus Tasks"] = "Visualizza Obiettivi Bonus"
L["When enabled, will place bonus tasks onto the quest tracker when your in range."] = "Quando abilitata, la visualizzazione della progressione degli obiettivi bonus apparira' nella lista delle missioni appena si entrera' nella zona giusta"
L["Show Progress Bar instead of Text"] = "Mostra Barra di Progresso invece del Testo"
L["If active, instead of a text, the percentage of progress will be shown with a bar."] = "Quando abilitata, verra' visualizzata una barra di progresso invece del testo con la percentuale"
L["Watch Challenge Modes"] = "Modalita' Sfida"
L["When enabled, will place the timer for your challenge mode at the top of your watch window"] = "Quando abilitata, il cronometro della modalita' sfida verra' posizionato alla sommita' della lista delle missioni"
L["Show Zone Achievement if Known"] = "Mostra Traguardi della Zona, se conosciuto"
L["When enabled, if carbonite knows there is a zone achievement for number of quests it will display it"] = "Quando abilitata, se nella zona e' disponibile in Carbonite un traguardo per numero di missioni completate, questa progressione verra' visualizzata"
...
L["When enabled, if the quest watch window fades, will ensure all of it fades text and all instead of just the window itself"] = "Quando abilitata, se la dissolvenza della finestra delle missioni e' attivata, verra' dissolto anche il testo delle missioni e non solo la finestra di contorno"
...
L["If a quest has an item to be used, will draw it beside the quest at the size defined here"] = "Se una missione richiede l'utilizzo di un oggetto da cliccare, sara' visualizzata l'icona dell'oggetto di fianco alla missione, della dimensione definita qui"
L["Item Transparency"] = "Trasparenza Icona Cliccabile"
L["Only uses the Alpha value, and is used to make clickable items in the watch list transparent"] = "Imposta o'a quantita' di trasparenza dell'icona cliccabile delle missioni"
...
L["When enabled, one of the selected sounds below will play on quest completion"] = "Quando abilitata, uno degli avvisi acustici della lista sottostante sara' suonato al completamento della missione"
L["Place a check in sounds you want carbonite to play when a quest is complete.\nChecking a box will play the sound for you to hear."] = "Flagga i suoni che desideri e Carbonite li riprodurra' a missione completata.\nFlaggando il suonmo verra' riprodotto chosì che tu possa scegliere"
...
L["Load Quests for Level 0 (holidays, professions, etc)"] = "Carica Missioni Livello 0 (Festivita', Eventi, Professioni, etc. etc. etc)"
...
L["Frenzyheart Tribe"] = "Tribu' dei Cuorferoce"
...
L["The Oracles"] = "Tribu' degli Oracoli"
...
L["Gathering Skill"] = "Abilita' Raccolta"
...
L["Cooking"] = "Cucina"
L["Fishing"] = "Pesca"
L["This objective is not in the database"] = "Questo obiettivo non e' presente nel Database"
L["This objective zone is not in the database"] = "Questa zona non e' presente nel database"
L["This quest is not in the database"] = "Questa missione non e' presente nel database"
L["Search: [click]"] = "Cerca: [click]"
L["Search: %[click%]"] = "Cerca: %[click%]"
L["Search: "] = "Cerca: "
L["Toggle High Watch Priority"] = "Dis/Attiva Visualizzazione Priorita'"
...
L["Hide Quests Farther Than"] = "Nascondi Missioni piu' distanti di"
