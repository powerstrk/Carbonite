...
L["Sets the number of characters before an objective wraps"] = "Imposta la quantità di caratteri tipografici prima dell'acapo"
...
L["When enabled, any new quest you pickup is automatically watched"] = "Quando abilitata, ogni nuova missione ricevuta sarà visualizzata nella lista in automatico"
L["Auto Watch Changed Quests"] = "Visualizza Progressione Missione Automatico"
L["When enabled, any quest whose objective changes from you looting an item, or talking to someone is automatically watched"] = "Quando abilitata, visualizza gli oggetti recuperati e/o i punti raggiunti e/o se si è parlato con un determinato soggetto"
...
L["When enabled, will place scenario status at the top of your watch window"] = "Quando abilitata, lo status dello scenario/missione bonus verrà visualizzato alla cima della lista delle missioni"
L["Watch Achievements"] = "Visualizza Traguardi"
L["When enabled, will place any tracked achievements at the top of your watch window"] = "Quando abilitata, tutti i Traguardi (Achievements) di cui è stato scelto di tener traccia, verranno visualizzati in cima alla lista delle missioni"
L["Watch Bonus Tasks"] = "Visualizza Obiettivi Bonus"
L["When enabled, will place bonus tasks onto the quest tracker when your in range."] = "Quando abilitata, la visualizzazione della progressione degli obiettivi bonus apparirà nella lista delle missioni appena si entrerà nella zona giusta"
L["Show Progress Bar instead of Text"] = "Mostra Barra di Progresso invece del Testo"
L["If active, instead of a text, the percentage of progress will be shown with a bar."] = "Quando abilitata, verrà visualizzata una barra di progresso invece del testo con la percentuale"
L["Watch Challenge Modes"] = "Modalità Sfida"
L["When enabled, will place the timer for your challenge mode at the top of your watch window"] = "Quando abilitata, il cronometro della modalità sfida verrà posizionato alla sommità della lista delle missioni"
L["Show Zone Achievement if Known"] = "Mostra Traguardi della Zona, se conosciuto"
L["When enabled, if carbonite knows there is a zone achievement for number of quests it will display it"] = "Quando abilitata, se nella zona è disponibile in Carbonite un traguardo per numero di missioni completate, questa progressione verrà visualizzata"
...
L["When enabled, if the quest watch window fades, will ensure all of it fades text and all instead of just the window itself"] = "Quando abilitata, se la dissolvenza della finestra delle missioni è attivata, verrà dissolto anche il testo delle missioni e non solo la finestra di contorno"
...
L["If a quest has an item to be used, will draw it beside the quest at the size defined here"] = "Se una missione richiede l'utilizzo di un oggetto da cliccare, sarà visualizzata l'icona dell'oggetto di fianco alla missione, della dimensione definita qui"
L["Item Transparency"] = "Trasparenza Icona Cliccabile"
L["Only uses the Alpha value, and is used to make clickable items in the watch list transparent"] = "Imposta òa quantità di trasparenza dell'icona cliccabile delle missioni"
...
L["When enabled, one of the selected sounds below will play on quest completion"] = "Quando abilitata, uno degli avvisi acustici della lista sottostante sarà suonato al completamento della missione"
L["Place a check in sounds you want carbonite to play when a quest is complete.\nChecking a box will play the sound for you to hear."] = "Flagga i suoni che desideri e Carbonite li riprodurrà a missione completata.\nFlaggando il suonmo verrà riprodotto chosì che tu possa scegliere"
...
L["Load Quests for Level 0 (holidays, professions, etc)"] = "Carica Missioni Livello 0 (Festività, Eventi, Professioni, etc. etc. etc)"
...
L["Frenzyheart Tribe"] = "Tribù dei Cuorferoce"
...
L["The Oracles"] = "Tribù degli Oracoli"
...
L["Gathering Skill"] = "Abilità Raccolta"
...
L["Cooking"] = "Cucina"
L["Fishing"] = "Pesca"
L["This objective is not in the database"] = "Questo obiettivo non è presente nel Database"
L["This objective zone is not in the database"] = "Questa zona non è presente nel database"
L["This quest is not in the database"] = "Questa missione non è presente nel database"
L["Search: [click]"] = "Cerca: [click]"
L["Search: %[click%]"] = "Cerca: %[click%]"
L["Search: "] = "Cerca: "
L["Toggle High Watch Priority"] = "Dis/Attiva Visualizzazione Priorità"
...
L["Hide Quests Farther Than"] = "Nascondi Missioni più distanti di"
