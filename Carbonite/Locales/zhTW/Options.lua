...
L["JimboBlue for guide location updates and checking"] = "JimboBlue 對百科指南興趣點位置的升級與確認"
...
L["Enable Compatability Mode"] = "啟用兼容模式"
L["When Enabled, Carbonite will performe combat checks before any map/window functions. This eliminates other UI's from causing protected mode errors."] = "啟用時, Carbonite在戰鬥中將會檢測窗體函數以防止與其它窗體插件衝突並產生界面錯誤。"
