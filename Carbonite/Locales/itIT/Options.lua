...
L["When enabled, Carbonite will combine the minimap into itself to create a more functional minimap for you (RELOAD REQUIRED)"] = "Quando abilitato, fonderà la Minimappa di Carbonite con la Minimappa Standard della Blizzard (RICHIEDE /reload)"
L["Minimap Shape is Square"] = "Minimappa Quadrata"
L["When enabled, Carbonite will change the minimap shape from circle to square"] = "Quando abilitato, Carbonite cambierà l'aspetto della mappa standard 'circolare' in una mappa 'quadrata'"
L["Minimap is drawn above icons"] = "Minimappa Sopra, Icone Sotto"
L["When enabled, Carbonite will draw the minimap above your map icons, you can use the CTRL key on your keyboard to toggle which layer is top"] = "Quando abilitato, Carbonite mostrerà la Minimappa sopra la mappa delle Icone. il tasto CTRL della tastiera cambia l'odine di strato"
...
L["Sets the scale of the icons drawn in the minimap portion of the map while docked"] = "Imposta la dimensione delle Icone della Minimappa quando quest'ultima è ancorata"
L["Minimap Node Glow Delay"] = "Velocità Pulsazione Nodi di Raccolta"
L["Sets the delay (in seconds) between the glow change on gathering nodes (0 is off)"] = "Imposta (in secondi) la velocità di pulsazioni dei Nodi di Raccolta (Erbalismo ed Estrazione) sulla minimappa - '0' (zero) disabilita la funzione"
L["Always dock minimap"] = "Ancora SEMPRE Minimappa"
L["When enabled, The minimap will always dock into the corner of the carbonite map."] = "Quando abilitato, la minimappa sarà SEMPRE ancorata nel angolo della mappa di Carbonite"
L["Dock The Minimap when indoors"] = "Ancora Minimappa negli Interni"
L["When enabled, The minimap will dock if wow says your indoors"] = "Quando abilitato, la minimappa verrà ancorata se si entrerà nell'interno di una struttura e/o se il Client definisce l'attuale ambiente come 'Interno' di qualcosa"
L["Dock The Minimap in Bugged Zones"] = "Ancora Minimappa in Zone Bugghe"
L["When enabled, The minimap will dock if your in a known transparency bug zone (Pitch black minimap)"] = "Quando abilitato, la minimappa verrà ancorata se si entrerà in una zona è conosciuta per il bug alla trasparenza (minimappa 'nero come la pece')"
L["Dock The Minimap when Fullsized"] = "Ancora Minimappa - Mappa Max Dimansione"
L["When enabled, The minimap will dock if your viewing the fullsized map."] = "Quando abilitato, la minimappa sarà ancorata se si sta consultando la Mappa con dimensione massimizzata (Full size)"
L["Hide The Minimap when Fullsized"] = "Nascondi Minimappa - Mappa Max Dimensione"
L["When enabled, The minimap will hide if your viewing the fullsized map."] = "Quando abilitato, la minimappa risulterà nascosta se si sta consultando la Mappa con dimensione massimizzata (Full Size)"
L["Minimap Docked Shape is Square"] = "Minimappa Ancorata -> Quadrata"
L["When enabled, The minimap will be square shaped while docked."] = "Quando abilitato, se la minimappa sarà ancorata la sua forma risulterà QUADRATA"
L["Minimap Docks Bottom"] = "Ancoraggio Minimappa - Basso"
L["When enabled, The minimap will dock to the bottom of the map."] = "Quando abilitato, la minimappa sarà ancorata ai piedi della Mappa"
L["Minimap Docks Right"] = "Ancoraggio Minimappa - Destra"
L["When enabled, The minimap will dock to the right side of the map."] = "Quando abilitato, la minimappa sarà ancorata sul lato destro della Mappa"
...
L["When enabled, The minimap will expand to full map window size when indoors."] = "Quando abilitato, la minimappa verrà espansa a Mappa in Massima dimensione quando si è in un Interno"
L["Minimap goes full sized in bugged areas"] = "Max Dimensione Minimappa Zone Bugghe"
L["When enabled, The minimap will expand to full map window size in known transparency bugged areas."] = "Quando abilitato, la minimappa verrà espansa a Mappa in Massima Dimensione quando si giunge in una zone in cui vi è un un BUg conosciuto sulla trasparenza"
L["Minimap goes full sized in instances"] = "Max Dimansione Minimappa Istanze"
L["When enabled, The minimap expand to full map window size when you enter a raid/instance."] = "Quando abilitato, la minimappa verrà espansa a Mappa in Massima Dimensione quando si entra in una istanza/Raid"
