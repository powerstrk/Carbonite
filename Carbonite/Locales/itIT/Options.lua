...
L["\nCarbonite is a full featured, powerful map addon providing a versitile easy to use google style map which either can replace or work with the current blizzard maps.\n\nThrough modules it can also be expanded to do even more to help make your game easier."] = "\nCarbonite \195\168 un potente e completo addon che mette a disposizione un semplice e versatile strumento in stile GOOGLE-MAPS, il quale pu\195\178 rimpiazzare e/o lavorare in collaborazione con la mappa di base di Blizzard. \n\nCon diversi moduli a disposizione \195\168 possibile espandere Carbonite ed ottenere uno strumento estremamente potente che ti permette di rendere un po' pi\195\185 semplice la tua esperienza di gioco"
...
L["Enable Compatability Mode"] = "Abilita Modalit\195\160 di Compatibilit\195\160"
...
L["When enabled, Carbonite will change the minimap shape from circle to square"] = "Quando abilitato, Carbonite cambier\195\160 l'aspetto della mappa standard 'circolare' in una mappa 'quadrata'"
...
L["When enabled, The minimap will dock if wow says your indoors"] = "Quando abilitato, la minimappa verr\195\160 ancorata se si entrer\195\160 nell'interno di una struttura e/o se il Client definisce l'attuale ambiente come 'Interno' di qualcosa"
L["Dock The Minimap in Bugged Zones"] = "Ancora Minimappa in Zone Bugghe"
L["When enabled, The minimap will dock if your in a known transparency bug zone (Pitch black minimap)"] = "Quando abilitato, la minimappa verr\195\160 ancorata se si entrer\195\160 in una zona \195\168 conosciuta per il bug alla trasparenza (minimappa 'nero come la pece')"
