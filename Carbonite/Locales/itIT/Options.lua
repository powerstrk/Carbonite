...
L["nelegalno for many cleanups, api fixes"] = "nelegalno, per le molte 'pulizi\195\168 del codice ed i fix alle 'api'"
...
L["When enabled, Carbonite will change the minimap shape from circle to square"] = "Quando abilitato, Carbonite cambier\195\160 l'aspetto della mappa standard 'circolar\195\168 in una mappa 'quadrat\195\160"
...
L["When enabled, The minimap will dock if wow says your indoors"] = "Quando abilitato, la minimappa verr\195\160 ancorata se si entrer\195\160 nell'interno di una struttura e/o se il Client definisce l'attuale ambiente come 'Intern\195\178 di qualcosa"
