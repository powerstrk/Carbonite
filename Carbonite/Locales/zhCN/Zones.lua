...
L["Temple of Ahn'Qiraj"] = true		--	need retranslation (Ahn'Qiraj = 安其拉)
...
L["Theramore's Fall (A)"] = true		--	Replaces Battle of Theramore (塞拉摩之战)
L["Theramore's Fall (H)"] = true		--	Replaces Battle of Theramore (塞拉摩之战)
...
L["The Stockade"] = true		--	Replaces Stormwind Stockade (暴风城监狱)
...
L["Tanaris"] = "塔纳利斯"
L["Teldrassil"] = "泰达希尔"
L["The Eye"] = true				--	Replaces Tempest Keep (风暴要塞)
