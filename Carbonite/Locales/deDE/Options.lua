...
L["sets the number of movement dots to draw on the map"] = "legt die Anzahl der Bewegungspunkte, welche auf die Karte gezeichnet werden fest."
...
L["Maximum Zones To Draw At Once"] = "Max Gebiete auf Einmal"
L["Sets the number of zones you can display at once on the map"] = "Setzt die Anzahl anzuzeigender Gebiete welche auf einmal angezeigt werden k\195\182nnen fest."
L["Detail Graphics Visible Area"] = "Sichtbarer Bereich Detail Grafiken"
L["Sets the area size available when zoomed into satellite mode on the map (REQUIRES RELOAD)"] = "Setzt die verf\195\188gbare Bereichsgr\195\182\195\159e fest wenn auf der Karte im Satelitenmodus gezoomt wird (ben\195\182tigt RELOAD)"
L["Map Mouse Button Binds"] = "Karten Maus Button Belegungen"
L["Alt Left Click"] = "ALT+Links Klick"
L["Sets the action performed when left clicking holding ALT"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn bei gedr\195\188ckter ALT-Taste Links geklickt wird"
L["Ctrl Left Click"] = "STRG+Links Klick"
L["Sets the action performed when left clicking holding CTRL"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn bei gedr\195\188ckter STRG-Taste Links geklickt wird"
L["Middle Click"] = "Mittelklick"
L["Sets the action performed when clicking your middle mouse button"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn die Mittlere Maustaste gedr\195\188ckt wird"
L["Alt Middle Click"] = "ALT+Mittel Klick"
L["Sets the action performed when middle clicking holding ALT"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn bei gedr\195\188ckter ALT-Taste die Mittlere Maustaste geklickt wird"
L["Ctrl Middle Click"] = "STRG+Mittel Klick"
L["Sets the action performed when middle clicking holding CTRL"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn bei gedr\195\188ckter STRG-Taste die Mittlere Maustaste geklickt wird"
L["Right Click"] = "Rechts Klick"
L["Sets the action performed when right clicking the map"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn die Rechte Maustaste auf der Karte gedr\195\188ckt wird"
L["Alt Right Click"] = "ALT+Rechts Klick"
L["Sets the action performed when Right clicking holding ALT"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn bei gedr\195\188ckter ALT-Taste Rechts geklickt wird"
L["Ctrl Right Click"] = "STRG-Rechts Klick"
L["Sets the action performed when right clicking holding CTRL"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn bei gedr\195\188ckter STRG-Taste Rechts geklickt wird"
L["Button 4 Click"] = "Taste 4 Klick"
L["Sets the action performed when clicking mouse button 4"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn die Maustaste 4 gedr\195\188ckt wird"
L["Alt Button 4 Click"] = "ALT+Taste 4 Klick"
L["Sets the action performed when pressing mouse 4 while holding ALT"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn bei gedr\195\188ckter ALT-Taste Maustaste 4 geklickt wird"
L["Ctrl Button 4 Click"] = "STRG+Taste 4 Klick"
L["Sets the action performed when clicking 4th mouse button holding CTRL"] = "Setzt die Aktion fest die ausgef\195\188hrt wird wenn bei gedr\195\188ckter STRG-Taste Maustaste 4 geklickt wird"

-- Minimap Options
L["MiniMap Options"] = "MiniKarten Optionen"
L["Combine Blizzard Minimap with Carbonite Minimap"] = "Blizzards Minikarte mit der Carbonite Minimap kombinieren"
L["When enabled, Carbonite will combine the minimap into itself to create a more functional minimap for you (RELOAD REQUIRED)"] = "Wenn aktiviert, wird Carbonite die Minikarten kombinieren um eine funktionalere Minikarte zu errzeugen (ben\195\182tigt RELOAD"
L["Minimap Shape is Square"] = "Minikarte quadratisch"
L["When enabled, Carbonite will change the minimap shape from circle to square"] = "Wenn aktiviert wird die Minikarte quadratisch und nicht mehr Rund angezeigt"
L["Minimap is drawn above icons"] = "Minikarte \195\188ber den Icons"
L["When enabled, Carbonite will draw the minimap above your map icons, you can use the CTRL key on your keyboard to toggle which layer is top"] = "Wenn aktiviert, werden die Icons von der Minikarte \195\188berlagert, du kannst die STRG-Taste verwenden um die Ebenen zu wechseln"
...
L["Docked Minimap Icon Scale"] = "angedockte Minikarte Ma\195\159stab"
L["Sets the scale of the icons drawn in the minimap portion of the map while docked"] = true
L["Minimap Node Glow Delay"] = "Minikartenpunkt Gl\195\188hverz\195\182gerung"
...
L["Dock The Minimap when indoors"] = "Minikarte in Geb\195\164uden andocken"
L["When enabled, The minimap will dock if wow says your indoors"] = true
L["Dock The Minimap in Bugged Zones"] = "Minikarten in verbuggten Gebieten andocken"
L["When enabled, The minimap will dock if your in a known transparency bug zone (Pitch black minimap)"] = true
L["Dock The Minimap when Fullsized"] = "Minikarte in Vollgr\195\182\195\159e andocken"
L["When enabled, The minimap will dock if your viewing the fullsized map."] = true
L["Hide The Minimap when Fullsized"] = "Minikarte in Vollgr\195\182\195\159e verstecken"
L["When enabled, The minimap will hide if your viewing the fullsized map."] = true
L["Minimap Docked Shape is Square"] = "angedockte Minikarte quadratisch"
...
L["Minimap Dock X-Offset"] = "Minikarte andocken X-Offset"
L["Sets the X - offset the minimap draws while docked"] = true
L["Minimap Dock Y-Offset"] = "Minikarte andocken Y-Offset"
L["Sets the Y - offset the minimap draws while docked"] = true
L["Minimap goes full sized Indoors"] = "Minikarte in Geb\195\164uden in Vollgr\195\182\195\159e"
L["When enabled, The minimap will expand to full map window size when indoors."] = true
L["Minimap goes full sized in bugged areas"] = "Minikarte in verbuggten Gebieten in Vollgr\195\182\195\159e"
L["When enabled, The minimap will expand to full map window size in known transparency bugged areas."] = true
L["Minimap goes full sized in instances"] = "Minikarte in Instanzen in Vollgr\195\182\195\159e"
L["When enabled, The minimap expand to full map window size when you enter a raid/instance."] = true
L["Move capture bars under map"] = "Verschiebe Erfassungsleisten unter die Karte"
...
L["Center Menus Horizontally On Cursor"] = "Zentriere Men\195\188s horizontal zum Cursor"
L["When Enabled, Carbonite Menus Will Be Drawn Horizontally Centered On The Mouse"] = true
L["Center Menus Vertically On Cursor"] = "Zentriere Men\195\188s vertikal zum Cursor"
...
L["Send Position & Level Ups To Friends"] = "Sene Postionen und Levelups an Freunde"
...
L["Send Position & Level Ups To Guild"] = "Sene Postionen und Levelups an deine Gilde"
...
L["Send Position & Level Ups To Zone"] = "Sene Postionen und Levelups an das Gebiet"
...
L["Show Received Levelups"] = "Zeige empfangene Levelups"
L["When Enabled, Carbonite will show a message in chat whenever it gets a notice someone leveled up"] = true
L["Enable Global Channel (Used for version checks/notices)"] = "aktiviere Globalen Kanal"
...
L["Enable Zone Channel (Used for locations of others in your zone)"] = "aktiviere Gebietskanal"
...
L["Battlegrounds"] = "Schlachtfelder"
L["Fonts"] = "Schriften"
L["Guide & Gather"] = "Guide und Farmen"
L["Maps"] = "Karten"
