...
L["If large map is open when you enter combat attempts to hide it."] = "Sollte die Große Karte offen sein, während ein Kampf beginnt wird versucht sie zu verbergen"
