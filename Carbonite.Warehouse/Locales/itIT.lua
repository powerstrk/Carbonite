...
L["When enabled, will show warehouse information in hover tooltips of items"] = "Quando abilitato, sara' mostrata una breve descrizione degli oggetti in una finestrella 'volante'"
...
L["Show Lowest Equipped Rarity"] = "Mostra la Rarita' piu' bassa dell'equipaggiamento"
L["Show Item Headers"] = "Mostra Titolo Oggetto"
L["Sort By Rarity"] = "Ordina per Rarita'"
L["Show Lowest Rarity"] = "Mostra Rarita' piu' Bassa"
